    ...
    <div className="flex flex-col bg-lightGray xl:py-20 xl:px-32 py-14 dark:bg-darkGray dark:text-white">
      ...
      <div className="lg:flex lg:justify-center whitespace-pre-wrap">
        <div className="flex justify-center">
          <div className="bg-white m-12 p-8 mt-0 flex flex-col xl:leading-6 rounded-xl lg:w-[520px] lg:h-h320 lg:absolute z-20 xl:gap-5 gap-3 dark:bg-Info">
        ...
        <div className="mx-12 lg:flex lg:flex-col p-8 gap-6 lg:max-w-[520px] leading-6 whitespace-pre-wrap">
