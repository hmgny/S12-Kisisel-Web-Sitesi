    ...
    return (
        <div className="p-12 dark:bg-middlegray dark:text-white">
            ...
            <div className="flex p-8 gap-12 justify-center">
                ...
                <div className="pt-8 px-8 gap-4 bg-Mavi flex flex-col max-w-md dark:bg-darkYesil">
                    ...
                    <div className="flex flex-wrap max-w-80 gap-2">
                        <button className="bg-white border-none w-20 h-8 rounded-border72px text-base dark:bg-Info">react</button>
                        <button className="bg-white border-none w-20 h-8 rounded-border72px text-base dark:bg-Info">vercel</button>
                        <button className="bg-white border-none w-20 h-8 rounded-border72px text-base dark:bg-Info">axios</button>
                        <button className="bg-white border-none w-20 h-8 rounded-border72px text-base dark:bg-Info">router</button>
                    </div>
                    <div className="flex justify-between pt-8 pb-20">
                        <a className="text-xl text-black no-underline dark:text-white" href="">Viev on Github</a>
                        <a className="text-xl text-black no-underline dark:text-white" href="">Go to app →</a>
                    </div>
                    <img className="max-w-full h-auto text-end" src="../public/images/proje.png"/>
                </div>

                <div className="pt-8 px-8 gap-4 bg-Yesil flex flex-col max-w-md dark:bg-middleYesil">
                    <h3 className="text-3xl font-bold">Are you bored</h3>
                    <p className="pr-16 text-base max-w-80 leading-6 font-normal">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Veniam aut, odit laborum aliquam voluptatum nisi mollitia.</p>
                    <div className="flex flex-wrap max-w-80 gap-2">
                        <button className="bg-white border-none w-20 h-8 rounded-border72px text-base dark:bg-Info">react</button>
                        <button className="bg-white border-none w-20 h-8 rounded-border72px text-base dark:bg-Info">vercel</button>
